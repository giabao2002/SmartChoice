		...
		<div x-show="activeSlide === 0" 
			...
			<div class="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center justify-center">
				<div class="text-center text-white px-8 transform transition-all duration-700" 
					...
					<h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 transform transition-transform duration-500 hover:scale-105 drop-shadow-lg">Smart Choice</h2>
					<p class="text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto mb-6 drop-shadow-md">Mua sắm sản phẩm mà bạn mơ ước.</p>
                    <button class="mt-4 px-6 py-3 bg-blue-600 text-white font-medium text-sm rounded-lg transition-all duration-300 hover:bg-blue-700 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-lg">
                        Khám phá ngay
                    </button>
				</div>
			</div>
		...
		<div x-show="activeSlide === 1"
			...
			<div class="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center justify-center">
				<div class="text-center text-white px-8 transform transition-all duration-700" 
                     ...
                     x-transition:enter-end="opacity-100 translate-y-0">
					<h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 transform transition-transform duration-500 hover:scale-105 drop-shadow-lg">Smart Choice</h2>
					<p class="text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto mb-6 drop-shadow-md">Mang lại cho bạn những sản phẩm chất lượng nhất.</p>
                    <button class="mt-4 px-6 py-3 bg-blue-600 text-white font-medium text-sm rounded-lg transition-all duration-300 hover:bg-blue-700 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-lg">
                        Khám phá ngay
                    </button>
				</div>
		...
		<div x-show="activeSlide === 2"
			...
			<div class="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center justify-center">
				<div class="text-center text-white px-8 transform transition-all duration-700" 
                     ...
                     x-transition:enter-end="opacity-100 translate-y-0">
					<h2 class="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 transform transition-transform duration-500 hover:scale-105 drop-shadow-lg">Smart Choice</h2>
					<p class="text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto mb-6 drop-shadow-md">Chúng tôi luôn cập nhật những mẫu sản phẩm mới nhất.</p>
                    <button class="mt-4 px-6 py-3 bg-blue-600 text-white font-medium text-sm rounded-lg transition-all duration-300 hover:bg-blue-700 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 shadow-lg">
                        Khám phá ngay
                    </button>
				</div>
