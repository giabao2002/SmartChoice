                    ...
                    <div class="space-y-4" x-data="{ openSection: null }">
                        ...
                        <div>
                            <button @click="openSection = openSection === 'shoes' ? null : 'shoes'"
                                ...
                                <i class="fas" :class="openSection === 'shoes' ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                            </button>
                        ...
                        <div>
                            <button @click="openSection = openSection === 'brands' ? null : 'brands'"
                                ...
                                <i class="fas" :class="openSection === 'brands' ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                            </button>
                        ...
                        <div>
                            <button @click="openSection = openSection === 'price' ? null : 'price'"
                                ...
                                <i class="fas" :class="openSection === 'price' ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                            </button>
                            <div x-show="openSection === 'price'"
                                ...
                                <ul class="space-y-2">
                                    <li>
                                        <a href="/cua-hang/gia=0-300000" class="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                            < 300,000 VNĐ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/cua-hang/gia=300000-500000" class="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                            300,000 ~ 500,000 VNĐ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/cua-hang/gia=500000-700000" class="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                            500,000 ~ 700,000 VNĐ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/cua-hang/gia=700000-1000000" class="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                            700,000 ~ 1,000,000 VNĐ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/cua-hang/gia=1000000-1500000" class="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                            1,000,000 ~ 1,500,000 VNĐ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/cua-hang/gia=1500000-2000000" class="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                            1,500,000 ~ 2,000,000 VNĐ
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/cua-hang/gia=2000000-10000000" class="text-gray-600 hover:text-blue-600 transition-colors duration-200">
                                            > 2,000,000 VNĐ
                                        </a>
                                    </li>
                                </ul>
        ...
        <div class="lg:w-3/4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach($sanphams as $sanpham)
                    @if(($timloaisanpham == '' && $timthuonghieu == '') || 
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                            <a href="/cua-hang/san-pham={{$sanpham->id_san_pham}}" class="block">
                                ...
                                <div class="p-4">
                                    <h4 class="text-lg font-semibold text-gray-800 mb-2">{{$sanpham->ten_san_pham}}</h4>
                                    <div class="flex items-center justify-between">
                                        @php
                                            $km = 0;
                                            foreach($khuyenmais as $khuyenmai) {
                                                if($khuyenmai['ten_khuyen_mai'] == $sanpham->ten_khuyen_mai) {
                                                    $km = sprintf('%d', $sanpham->don_gia * 0.01 * $khuyenmai['gia_tri_khuyen_mai']);
                                                }
                                            }
                                        @endphp
