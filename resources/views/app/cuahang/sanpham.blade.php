                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4">
                                    <span>{{ session('success_rating') }}</span>
                                </div>
                                @endif
                                ...
                                <form action="/cua-hang/san-pham={{ $sanpham['id_san_pham'] }}/danh-gia"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="ten_danh_gia"
                                            ...
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('ten_danh_gia') border-red-500 @enderror">
                                        @error('ten_danh_gia')
                                            <p class="text-red-500 text-xs mt-1">{{ $errors->first('ten_danh_gia') }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Bình luận đánh
                                            giá</label>
                                        <textarea name="danh_gia_binh_luan" rows="4" required
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('danh_gia_binh_luan') border-red-500 @enderror"></textarea>
                                        @error('danh_gia_binh_luan')
                                            <p class="text-red-500 text-xs mt-1">{{ $errors->first('danh_gia_binh_luan') }}</p>
                                        @enderror
                                    </div>
